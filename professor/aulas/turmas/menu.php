      ...
      <ul>
        ...
        <li class="sidebar-dropdown">
          ...
          <div class="sidebar-submenu">
              <ul>
                  <li>
                      <a href="./avaliacoes/?opt=13">Listar</a>
                  </li>
                  <li>
                      <a href="./avaliacoes/?opt=0">Criar</a>
                  </li>
                  <li>
          ...
          <li class="sidebar-dropdown">
              ...
              <ul>
                  <li>
                      <a href="./?opt=5">Listar</a>
                  </li>
                  <li>
                      <a href="./?opt=0">Criar</a>
                  </li>
                  <li>
                      <a href="./?opt=1">Deletar</a>
                  </li>
                  <li>
                      <a href="./?opt=2">Editar</a>
                  </li>
              </ul>
              </div>
          </li>
          ...
          <li class="sidebar-dropdown">
              ...
              <ul>
                  <li>
                      <a class="dropdown-item" href="./pontuacao/?opt=0">Alu2313123321nos</a>
                  </li>
                  <li>
                      <a class="dropdown-item" href="./pontuacao/?opt=1">Gráficos</a>
                  </li>
              </ul>
              </div>
          </li>
